          ...
          <form className="form__register" onSubmit={handleSubmit}>
            <div className="form__content">
              ...
              <div className="form__input">
                ...
                <span>{STRING.login.cfPassword}</span>
